...
<div class="statement">
  ...
  <strong>${findings.total_controls || 0} controls</strong>. It was generated by ComplianceGuard on ${escapeHtml(dateText)}.</p>
...
<div class="content">
  ...
  <div class="summary-grid">
    <div class="summary-card total"><div class="value">${findings.total_controls || 0}</div><div class="label">Total Controls</div></div>
    <div class="summary-card compliant"><div class="value" style="color:#2E7D32">${findings.compliant_controls || 0}</div><div class="label">Compliant</div></div>
    <div class="summary-card partial"><div class="value" style="color:#E65100">${findings.partial_controls || 0}</div><div class="label">Partial</div></div>
    <div class="summary-card non-compliant"><div class="value" style="color:#C62828">${findings.non_compliant_controls || 0}</div><div class="label">Non-Compliant</div></div>
  </div>

  <p>The evaluation covers <strong>${findings.total_controls || 0} controls</strong> across the
