...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-~1271%20total-10B981?logo=pytest&logoColor=white" alt="Tests">
...
CI runs all tests on every push via GitHub Actions, and the desktop (Electron) test suite gates releases. Backend: 450 unit + 43 integration + 9 e2e. Frontend: 257 Vitest unit. Electron: 512. Playwright e2e: 9.
