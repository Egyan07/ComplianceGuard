...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-452%20passing-10B981?logo=pytest&logoColor=white" alt="Tests">
...
│   │   └── test/                       # Vitest test suite (156 tests)
...
CI runs all tests on every push via GitHub Actions. **~452 tests passing** — backend: ~247 (213 unit + 26 integration + 8 e2e), frontend: 156 Vitest unit + 29 Electron unit (10 scheduler + 13 engine + 6 sqlite), e2e: 5 Playwright.
...
| CI/CD with ~452 tests (~247 backend + 156 frontend + 29 Electron + 5 e2e) | |
